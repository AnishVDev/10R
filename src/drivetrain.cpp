...
void Drivetrain::autonomousTurn(int degrees, int speed) {
    ...
    double wheelBaseWidth = 24; // Example: Distance between left and right wheels in inches
    double wheelDiameter = 3.25;  // Example: Diameter of wheels in inches
    ...
    // Command motors: left motors go forward, right motors go backward
